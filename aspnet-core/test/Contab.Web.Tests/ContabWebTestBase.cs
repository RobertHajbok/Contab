...
{
    public abstract class ContabWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ContabWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ContabWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ContabDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ContabDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ContabDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ContabDbContext, Task<T>> func)
        {
            T result;
